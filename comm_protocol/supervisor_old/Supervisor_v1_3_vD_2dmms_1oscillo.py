...
import Oscillo_v1b as controloscillo
...
##      print(f"Sent command with frequency: {frequency_value}, message: {message1}")
  ...
  # Oscillo : Config Trigger + Sequence MODE + Single Trigg
  InitOscillo()
  ...
  #ReadHistoryOnly()
  # Read Oscillo History and save or not based on values set at the beginning
  ReadHistoryAndChooseToSave()
